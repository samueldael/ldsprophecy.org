(function($)
{
  ...
  sfm_hyper_link_popup = function(anchor,url,p_width,p_height)
  {
    ...
    var $dlg = $("<div class='sfm_popup_container'><iframe id='"+iframeid+"'  frameborder='0' src='../../../Send_Message/code/scripts/"+url+"' width='100%' height='100%'></iframe></div>");
  ...
  {
    var $dlg = $("<div class='sfm_popup_container'><iframe frameborder='0' src='../../../Send_Message/code/scripts/"+url+"' width='100%' height='100%'></iframe></div>");
  ...
  sfmFormObj=function(p_divid,p_url,p_height,options_param)
  {
    ...
    $(function()
    {
        $ifr = $("<iframe frameborder='0' src='../../../Send_Message/code/scripts/"+options.url+"' width='100%' height='"+options.height+"' allowtransparency='true'></iframe>");
