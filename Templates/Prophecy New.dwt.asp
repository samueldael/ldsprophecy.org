...
<div class="container">
<!-- TemplateBeginEditable name="EditRegionMenu" -->
  <div id="apDivMenu">
  ...
  <div class="content">
    ...
    <p>If you need to use these properties, you'll need to </p>
    <div id="apDiv1"><img src="../Image/mormon-prophecy-header.png" width="755" height="130" /></div>
    <p>use a different clearing method. The most reliable will be to add a &lt;br class=&quot;clearfloat&quot; /&gt; or &lt;div  class=&quot;clearfloat&quot;&gt;&lt;/div&gt; after your final floated column (but before the .container closes). This will have the same clearing effect.</p>
    <h3>Footer</h3>
